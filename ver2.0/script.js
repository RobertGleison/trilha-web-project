...
function checkBoard(){ // bastante feio, alias bem feio, ta uma vergonha, nao to afim de arrumar agora talvez de para separar mais por funcoes
    for(let i = 0; i< n ;i++){
        ...
        if((game_list[i][0] == 'red' && !document.getElementById((i+1).toString().concat("1"))?.classList.contains("is_in_mill_horizontal") && !document.getElementById((i+1).toString().concat("1"))?.classList.contains((i+1).toString().concat("1_LockHR"))) 
            && (game_list[i][1] == 'red' && !document.getElementById((i+1).toString().concat("2"))?.classList.contains("is_in_mill_horizontal") && !document.getElementById((i+1).toString().concat("1"))?.classList.contains((i+1).toString().concat("2_LockHR"))) 
            && (game_list[i][2] == 'red' && !document.getElementById((i+1).toString().concat("3"))?.classList.contains("is_in_mill_horizontal")&& !document.getElementById((i+1).toString().concat("1"))?.classList.contains((i+1).toString().concat("3_LockHR")))){ //modificar true por indicador de mill
        ...
        if((game_list[i][0] == 'black' && !document.getElementById((i+1).toString().concat("1"))?.classList.contains("is_in_mill_horizontal") && !document.getElementById((i+1).toString().concat("1"))?.classList.contains((i+1).toString().concat("1_LockHB"))) 
            && (game_list[i][1] == 'black' && !document.getElementById((i+1).toString().concat("2"))?.classList.contains("is_in_mill_horizontal") && !document.getElementById((i+1).toString().concat("1"))?.classList.contains((i+1).toString().concat("2_LockHB"))) 
            && (game_list[i][2] == 'black' && !document.getElementById((i+1).toString().concat("3"))?.classList.contains("is_in_mill_horizontal")&& !document.getElementById((i+1).toString().concat("1"))?.classList.contains((i+1).toString().concat("3_LockHB")))){ //modificar true por indicador de mill
                document.getElementById((i+1).toString().concat("1"))?.classList.add("is_in_mill_horizontal")
        ...
        if((game_list[i][2] != 'red' && document.getElementById((i+1).toString().concat("6"))?.classList.contains("is_in_mill_vertical") && document.getElementById((i+1).toString().concat("3"))?.classList.contains((i+1).toString().concat("3_LockVR"))) 
            || (game_list[i][4] != 'red' && document.getElementById((i+1).toString().concat("7"))?.classList.contains("is_in_mill_vertical") && document.getElementById((i+1).toString().concat("5"))?.classList.contains((i+1).toString().concat("5_LockVR"))) 
            || (game_list[i][7] != 'red' && document.getElementById((i+1).toString().concat("8"))?.classList.contains("is_in_mill_vertical") && document.getElementById((i+1).toString().concat("8"))?.classList.contains((i+1).toString().concat("8_LockVR")))){ //modificar true por indicador de mill
                document.getElementById((i+1).toString().concat("3"))?.classList.remove("is_in_mill_horizontal")
        ...
        if(i + 2 < n){
            ...
            && (game_list[i+2][1] == 'red' && !document.getElementById((i+3).toString().concat("2"))?.classList.contains("is_in_mill_vertical") && !document.getElementById((i+3).toString().concat("2"))?.classList.contains((i+3).toString().concat("2_LockVR")))){ //modificar true por indicador de mill
                ...
                document.getElementById((i+2).toString().concat("2"))?.classList.add("is_in_mill_horizontal")
                document.getElementById((i+2).toString().concat("2"))?.classList.add((i+2).toString().concat("2_LockVR"))
                document.getElementById((i+3).toString().concat("2"))?.classList.add("is_in_mill_horizontal")
            ...
            || (game_list[i+2][1] != 'red' && document.getElementById((i+3).toString().concat("2"))?.classList.contains("is_in_mill_vertical") && document.getElementById((i+3).toString().concat("2"))?.classList.contains((i+3).toString().concat("2_LockVR")))){ //modificar true por indicador de mill
                ...
                document.getElementById((i+2).toString().concat("2"))?.classList.remove("is_in_mill_horizontal")
                document.getElementById((i+2).toString().concat("2"))?.classList.remove((i+2).toString().concat("2_LockVR"))
                document.getElementById((i+3).toString().concat("2"))?.classList.remove("is_in_mill_horizontal")
            ...
            && (game_list[i+2][6] == 'red' && !document.getElementById((i+3).toString().concat("7"))?.classList.contains("is_in_mill_vertical") && !document.getElementById((i+3).toString().concat("7"))?.classList.contains((i+3).toString().concat("7_LockVR")))){ //modificar true por indicador de mill
                ...
                document.getElementById((i+2).toString().concat("7"))?.classList.add("is_in_mill_horizontal")
                document.getElementById((i+2).toString().concat("7"))?.classList.add((i+2).toString().concat("7_LockVR"))
                document.getElementById((i+3).toString().concat("7"))?.classList.add("is_in_mill_horizontal")
            ...
            || (game_list[i+2][6] != 'red' && document.getElementById((i+3).toString().concat("7"))?.classList.contains("is_in_mill_vertical") && document.getElementById((i+3).toString().concat("7"))?.classList.contains((i+3).toString().concat("7_LockVR")))){ //modificar true por indicador de mill
                ...
                document.getElementById((i+2).toString().concat("7"))?.classList.remove("is_in_mill_horizontal")
                document.getElementById((i+2).toString().concat("7"))?.classList.remove((i+2).toString().concat("7_LockVR"))
                document.getElementById((i+3).toString().concat("7"))?.classList.remove("is_in_mill_horizontal")
        ...
        if((game_list[i][2] != 'black' && document.getElementById((i+1).toString().concat("6"))?.classList.contains("is_in_mill_vertical") && document.getElementById((i+1).toString().concat("3"))?.classList.contains((i+1).toString().concat("3_LockVB"))) 
            || (game_list[i][4] != 'black' && document.getElementById((i+1).toString().concat("7"))?.classList.contains("is_in_mill_vertical") && document.getElementById((i+1).toString().concat("5"))?.classList.contains((i+1).toString().concat("5_LockVB"))) 
            || (game_list[i][7] != 'black' && document.getElementById((i+1).toString().concat("8"))?.classList.contains("is_in_mill_vertical") && document.getElementById((i+1).toString().concat("8"))?.classList.contains((i+1).toString().concat("8_LockVB")))){ //modificar true por indicador de mill
                document.getElementById((i+1).toString().concat("3"))?.classList.remove("is_in_mill_horizontal")
    ...
    if(color == "black"){
        ...
        const buttons = document.querySelectorAll('.button'); 
            buttons.forEach(button => {
                const id= button.id.split('').map(Number);
                if(game_list[id[0]-1][id[1]-1] == 'black'){
